...
$ThresholdPercent = 3; ### Percent free
$ThresholdExceeded = $false;
$emailAddress = 'it@rayzist.com';
$smtp = 'smtp.dottek.com';
...
add-content $fileName  "<font face='tahoma' color='#003399' size='4'><strong>Disk Report - $timeStamp</strong></font>" 
add-content $fileName  "</td>" 
...
$freePercent = [Math]::Round($freePercent,2)
 if ($freePercent -lt $Script:ThresholdPercent <#-or $frSpace -lt $Script:Threshold#>) { $Script:ThresholdExceeded = $true; };
...
if ($ThresholdExceeded) {
    #Write-Host "`r`nEmail sent!"
    #sendEmail $emailAddress $emailAddress "Server Disk Space Critically Low! - $Date" $smtp $freeSpaceFileName;
}